...
class ProfileController extends AbstractController
{
    ...
    public function displayAction(Request $request, $uid = null)
    {
        ...
        $templateParameters = [
            ...
            'rawUser' => $this->get('zikula_users_module.user_repository')->find($uid)
        ];

        // Return the output that has been generated by this function
        if (!empty($page)) {
            try {
                return $this->render('@ZikulaProfileModule/Profile/display_'.$page.'.html.twig', $templateParameters);
            } catch (\Exception $e) {

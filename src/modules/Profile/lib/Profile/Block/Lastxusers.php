...
class Profile_Block_Lastxusers extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $this->view->fetch('profile_block_lastxusers.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        return $this->view->fetch('profile_block_lastxusers_modify.htm');
    }
    ...
    public function update($blockinfo)
    {
        ...
        $this->view->clear_cache('profile_block_lastxusers.htm');

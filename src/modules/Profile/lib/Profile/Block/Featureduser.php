...
class Profile_Block_Featureduser extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $this->view->fetch('profile_block_featureduser.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        return $this->view->fetch('profile_block_featureduser_modify.htm');
    }
    ...
    public function update($blockinfo)
    {
        ...
        $this->view->clear_cache('profile_block_featureduser.htm');

...
class Profile_Admin extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        // Return the output
        return $this->renderer->fetch('profile_admin_main.htm');;
    }
    ...
    public function help()
    {
        ...
        // Return the output
        return $this->renderer->fetch('profile_admin_help.htm');;
    }
    ...
    public function view()
    {
        ...
        $this->renderer->assign('pager', array('numitems'     => $count,
                'itemsperpage' => $numitems));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_admin_view.htm');
    }
    ...
    public function newdud()
    {
        ...
        $this->renderer->assign('displaytypes',     array(0 => DataUtil::formatForDisplay($this->__('Text box')),
        ...
        $this->renderer->assign('requiredoptions',  array(0 => DataUtil::formatForDisplay($this->__('No')),
                1 => DataUtil::formatForDisplay($this->__('Yes'))));

        $this->renderer->assign('viewbyoptions',    array(0 => DataUtil::formatForDisplay($this->__('Everyone')),
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_admin_new.htm');
    }
    ...
    public function modify($args)
    {
        ...
        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_admin_modify.htm');
    }
    ...
    public function delete($args)
    {
        ...
        if (empty($confirmation)) {
            ...
            // Return the output that has been generated by this function
            return $this->renderer->fetch('profile_admin_delete.htm');
        }
    ...
    public function modifyconfig()
    {
        ...
        $this->renderer->setCache(false)->$this->renderer->add_core_data();
        $this->renderer->assign('dudfields', $items);

        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_admin_modifyconfig.htm');
    }

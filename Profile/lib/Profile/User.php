...
class Profile_User extends Zikula_Controller
{
    ...
    public function modify($args)
    {
        ...
        $render->assign('uname',    (isset($uname) && !empty($uname)) ? $uname : UserUtil::getVar('uname'));
    ...
    if ($render->is_cached('profile_user_members_view.htm')) {
        ...
        */
        ...
        $render->assign('memberslistreg',    ModUtil::apiFunc('Users', 'user', 'countitems')-1); // discount annonymous
        $render->assign('memberslistonline', ModUtil::apiFunc('Profile', 'memberslist', 'getregisteredonline'));
        $render->assign('memberslistnewest', UserUtil::getVar('uname', ModUtil::apiFunc('Profile', 'memberslist', 'getlatestuser')));
        ...
        $render->assign('msgmodule', ModUtil::apiFunc('Profile', 'memberslist', 'getmessagingmodule'));
    ...
    public function recentmembers()
    {
        ...
        // set the cache id
        $render->cache_id = 'recent' . UserUtil::isLoggedIn();
        ...
        $modvars = ModUtil::getVar('Profile');
    ...
    public function onlinemembers()
    {
        ...
        // set the cache id
        $render->cache_id = 'onlinemembers' . UserUtil::isLoggedIn();

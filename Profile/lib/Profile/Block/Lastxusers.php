...
class Profile_Block_Lastxusers extends Zikula_Api
{
    ...
    public function display($blockinfo)
    {
        ...
        $blockinfo['content'] = $this->renderer->fetch('profile_block_lastxusers.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        $this->renderer->assign('amount', $vars['amount']);
        $this->renderer->assign('savelastlogindate', ModUtil::getVar('Users','savelastlogindate'));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_block_lastxusers_modify.htm');
    }
    ...
    public function update($blockinfo)
    {
        ...
        $this->renderer->clear_cache('profile_block_lastxusers.htm');

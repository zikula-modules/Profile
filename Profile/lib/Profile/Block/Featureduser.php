...
class Profile_Block_Featureduser extends Zikula_Block
{
    ...
    public function display($blockinfo)
    {
        ...
        // build the output
        $this->renderer->setCache_Id('featured'.$vars['username']);

        $this->renderer->assign('userinfo',    $userinfo);
        $this->renderer->assign('showregdate', $vars['showregdate']);
        $this->renderer->assign('dudarray',    $dudarray);

        $blockinfo['content'] = $this->renderer->fetch('profile_block_featureduser.htm');
    ...
    public function modify($blockinfo)
    {
        ...
        $this->renderer->assign('username',     $vars['username']);
        $this->renderer->assign('showregdate',  $vars['showregdate']);
        $this->renderer->assign('dudarray',     $dudarray);
        $this->renderer->assign('fieldstoshow', array_flip($vars['fieldstoshow']));

        // Return the output that has been generated by this function
        return $this->renderer->fetch('profile_block_featureduser_modify.htm');
    }
    ...
    public function update($blockinfo)
    {
        ...
        $this->renderer->clear_cache('profile_block_featureduser.htm');

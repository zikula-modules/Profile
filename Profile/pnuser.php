...
function Profile_user_view($args)
{
    ...
    $render->assign('sameuser', $sameuser);
...
*/
    ...
    $render->assign('memberslistreg',    pnModAPIFunc('Profile', 'memberslist', 'countitems'));
    ...
    $render->assign('pager', array('numitems' => pnModAPIFunc('Profile', 'memberslist', 'countitems', array('letter' => $letter)),
                                   'itemsperpage' => pnModGetVar('Profile', 'memberslistitemsperpage')));

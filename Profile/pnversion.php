...
$modversion['description']    = __('Provides a personal account control panel for each registered user, an interface to administer the information items (controls) displayed in it, and a members list functionality. Works in close unison with the Users module.', $dom);

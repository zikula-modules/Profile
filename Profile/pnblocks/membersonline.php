 ...
 * @version $Id: membersonline.php 335 2009-11-09 06:52:03Z drak $
...
function Profile_membersonlineblock_info()
{
    ...
    return array('module'          => 'Profile',
                 'text_type'       => DataUtil::formatForDisplay(__('Members Online', $dom)),
                 'text_type_long'  => DataUtil::formatForDisplay(__('Show Members Online', $dom)),
                 'allow_multiple'  => true,
                 'form_content'    => false,
                 'form_refresh'    => false,
                 'show_preview'    => true,

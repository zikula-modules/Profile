 ...
 * @version $Id: lastseen.php 335 2009-11-09 06:52:03Z drak $
...
function Profile_lastseenblock_info()
{
    ...
    return array('module'          => 'Profile',
                 'text_type'       => DataUtil::formatForDisplay(__('Recently seen users', $dom)),
                 'text_type_long'  => DataUtil::formatForDisplay(__('Show recently seen users', $dom)),
                 'allow_multiple'  => true,
                 'form_content'    => false,
                 'form_refresh'    => false,
                 'show_preview'    => true,

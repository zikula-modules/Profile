        ...
        <fieldset>
            ...
            <div class="form-group" id="profile_content_wrapper">
                ...
                <div class="col-lg-9">
                    ...
                    <p class="alert alert-info" id="profile_help_type5">{gt text="Notice: You can choose the date format to use: 'EUR' (day month year, default), 'US' (month day, year) or 'DB' (YYYY-MM-DD). Month names are automatically translated."}</p>

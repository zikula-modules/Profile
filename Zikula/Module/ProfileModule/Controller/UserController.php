...
class UserController extends \Zikula_AbstractController
{
    ...
    public function viewAction($args)
    {
        ...
        $this->view->assign('dudarray', $dudarray)->assign('fields', $activeduds)->assign('fieldsets', $fieldsets)->assign('uid', $userinfo['uid'])->assign('uname', $userinfo['uname'])->assign('userinfo', $userinfo)->assign('ismember', $ismember)->assign('isadmin', $isadmin)->assign('sameuser', $isowner);

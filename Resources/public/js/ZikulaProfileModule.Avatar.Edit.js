...
(function($) {
    function showAvatar()
    {
        ...
        $('.avatar-selector').each(function (index) {
            ...
            avatarUrl = '';
            if ($(this).val() != 'blank.jpg') {
                if ($(this).val() == '' || $(this).val() == 'gravatar.jpg') {
            ...
            avatarPreview = avatarUrl != '' ? '<img src="' + avatarUrl + '" alt="' + Translator.__('Avatar') + '" class="img-responsive img-thumbnail" />' : '';
